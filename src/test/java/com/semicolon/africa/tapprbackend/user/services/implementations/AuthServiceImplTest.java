...
//        CreateNewUserResponse response = authenticationService.register(createNewUserRequest).getData();
//        assertEquals(response.getMessage(),"User created successfully");
//
//        LoginResponse loginResponse = authenticationService.login(loginRequest).getData();
